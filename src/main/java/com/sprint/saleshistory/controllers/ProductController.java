...
public class ProductController {
    ...
    // add new ProductPojo
    @PostMapping
    public ResponseEntity<String> addProductPojo(@RequestBody ProductPojo product) {
    ...
    @PutMapping
    public ResponseEntity<String> updateProductPojo(@RequestBody ProductPojo product) {
    ...
    public ResponseEntity<String> deleteProductPojo(@PathVariable int id) {
